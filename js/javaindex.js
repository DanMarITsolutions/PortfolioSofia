...
function iniciarFormularioContacto() {
  ...
  const cerrarModal = document.querySelector("#form-modal-close");
  const botonModal = document.querySelector("#form-modal-button");
  const fondoModal = document.querySelector("#form-modal-backdrop");
  ...
  if (
    ...
    console.warn("No se ha podido iniciar el formulario de contacto.");
    return;
  }
  ...
  cerrarModal.addEventListener("click", cerrarPopup);

  botonModal.addEventListener("click", cerrarPopup);

  fondoModal.addEventListener("click", cerrarPopup);
